...
# if we have not detected 4 markers in image we cannot apply augumented reality technique so will exit out
if len(corners)!=4:
...
print('[INFO] constructing the Augumented reality visualization...')
ids = ids.flatten()
refPts = []

# Loopover the ids of ArUCo markers in top-left, top-right, bottom-right and bottom-left order
...
print(f'refPtTL: {refPtTL}')
print(f'refPtTL[0]: {refPtTL[0]}')
