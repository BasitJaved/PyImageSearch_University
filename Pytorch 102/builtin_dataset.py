...
train_dataset = MNIST(root=config.mnist_dataset_path, train=True, download=True, transform=transforms)
val_dataset = MNIST(root=config.mnist_dataset_path, train=False, download=True, transform=transforms)
