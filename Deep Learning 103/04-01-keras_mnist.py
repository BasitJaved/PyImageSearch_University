...
# Each image in mnist data is represented as a 28x28x1 image but in order to apply a standard neural network we
# must first flatten the image to simple list of 28x28=784 pixels
